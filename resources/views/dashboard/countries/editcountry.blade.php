						...
						<div class="row">
							...
							<div class="col-lg-12 col-md-12">
								<div class="card">
									...
									<div class="card-body">
										<form class="row g-3" method="POST" action="{{ route('editCountrydone',['id' => $country->id]) }}">
                                            @csrf
											<div class="col-md-4">
											  <label for="validationDefault01" class="form-label"> تعديل اسم المدينة</label>
											  <input placeholder="ادخل اسم المدينة" type="text" name="country_name" class="form-control"  value="{{ $country->country_name }}" required>
											</div>
